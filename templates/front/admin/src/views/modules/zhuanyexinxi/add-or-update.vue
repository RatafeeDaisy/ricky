          ...
          <el-form-item class="input" label="专业名称" prop="zhuanyemingcheng">
              <el-input v-model="ruleForm.zhuanyemingcheng" 
                placeholder="专业名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业简介" prop="zhuanyejianjie">
          <el-input v-model="ruleForm.zhuanyejianjie" 
              placeholder="专业简介" clearable  :readonly="ro.zhuanyejianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业简介" prop="zhuanyejianjie">
              <el-input v-model="ruleForm.zhuanyejianjie" 
                placeholder="专业简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuanyemingcheng = true;
            continue;
	            	            ...
	            	            if(o=='zhuanyejianjie'){
            this.ruleForm.zhuanyejianjie = obj[o];
	    this.ro.zhuanyejianjie = true;
            continue;
          }
	                    }
                                              }
