          ...
          <el-form-item class="input" label="学院名称" prop="xueyuanmingcheng">
              <el-input v-model="ruleForm.xueyuanmingcheng" 
                placeholder="学院名称" readonly></el-input>
                                      ...
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学院简介" prop="xueyuanjianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学院简介"
                  v-model="ruleForm.xueyuanjianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xueyuanjianjie" label="学院简介" prop="xueyuanjianjie">
                    <span>{{ruleForm.xueyuanjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuanmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='xueyuanjianjie'){
            this.ruleForm.xueyuanjianjie = obj[o];
	    this.ro.xueyuanjianjie = true;
            continue;
          }
	                    }
                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueyuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueyuanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
