          ...
          <el-form-item class="input" label="楼号" prop="louhao">
              <el-input v-model="ruleForm.louhao" 
                placeholder="楼号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="楼层号" prop="loucenghao">
          <el-input v-model="ruleForm.loucenghao" 
              placeholder="楼层号" clearable  :readonly="ro.loucenghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="楼层号" prop="loucenghao">
              <el-input v-model="ruleForm.loucenghao" 
                placeholder="楼层号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.susheleixing"
                placeholder="宿舍类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍位置" prop="susheweizhi">
          <el-input v-model="ruleForm.susheweizhi" 
              placeholder="宿舍位置" clearable  :readonly="ro.susheweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍位置" prop="susheweizhi">
              <el-input v-model="ruleForm.susheweizhi" 
                placeholder="宿舍位置" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.sushezhaopian" label="宿舍照片" prop="sushezhaopian">
          <file-upload
          tip="点击上传宿舍照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.sushezhaopian?ruleForm.sushezhaopian:''"
          @change="sushezhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.sushezhaopian" label="宿舍照片" prop="sushezhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.sushezhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.louhao = true;
            continue;
	            	            ...
	            	            if(o=='loucenghao'){
            this.ruleForm.loucenghao = obj[o];
	    this.ro.loucenghao = true;
            continue;
          }
	            	            if(o=='sushehao'){
	    ...
	    this.ro.susheweizhi = true;
            continue;
	            	            ...
	            	            if(o=='sushezhaopian'){
            this.ruleForm.sushezhaopian = obj[o];
	    this.ro.sushezhaopian = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                    ...
                                                                                    sushezhaopianUploadChange(fileUrls) {
                this.ruleForm.sushezhaopian = fileUrls;
				this.addEditUploadStyleChange()
            },
            	addEditStyleChange() {
	  this.$nextTick(()=>{
