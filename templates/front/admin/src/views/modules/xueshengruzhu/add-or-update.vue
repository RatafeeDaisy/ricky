          ...
          <el-form-item class="input" label="宿舍号" prop="sushehao">
              <el-input v-model="ruleForm.sushehao" 
                placeholder="宿舍号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="床铺号" prop="chuangpuhao">
          <el-input v-model="ruleForm.chuangpuhao" 
              placeholder="床铺号" clearable  :readonly="ro.chuangpuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="床铺号" prop="chuangpuhao">
              <el-input v-model="ruleForm.chuangpuhao" 
                placeholder="床铺号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	beizhu : false,
            ...
            ruleForm: {
                  ...
                  chuangpuhao: [
                            { required: true, message: '床铺号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  beizhu: [
                                    	                                                              ],
              }
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sushehao = true;
            continue;
	            	            ...
	            	            if(o=='chuangpuhao'){
            this.ruleForm.chuangpuhao = obj[o];
	    this.ro.chuangpuhao = true;
            continue;
          }
	            	            if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
                ...
                this.ruleForm.xingbie = data.data.xingbie
                                                ...
                                                if(data.data.nianji){
                this.ruleForm.nianji = data.data.nianji
              }
                                                if(data.data.nianling){
                this.ruleForm.nianling = data.data.nianling
              }
                                                if(data.data.xueyuan){
                this.ruleForm.xueyuan = data.data.xueyuan
              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueshengruzhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueshengruzhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
