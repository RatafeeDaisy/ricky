          ...
          <el-form-item class="input" label="报修物品" prop="baoxiuwupin">
              <el-input v-model="ruleForm.baoxiuwupin" 
                placeholder="报修物品" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="描述" prop="miaoshu">
          <el-input v-model="ruleForm.miaoshu" 
              placeholder="描述" clearable  :readonly="ro.miaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="描述" prop="miaoshu">
              <el-input v-model="ruleForm.miaoshu" 
                placeholder="描述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shebeibaoxiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeibaoxiuCrossAddOrUpdateFlag = false;
                  this.parent.search();
