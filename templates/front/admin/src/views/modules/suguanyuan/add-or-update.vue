<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿管员姓名" prop="suguanyuanxingming">
          <el-input v-model="ruleForm.suguanyuanxingming" 
              placeholder="宿管员姓名" clearable  :readonly="ro.suguanyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿管员姓名" prop="suguanyuanxingming">
              <el-input v-model="ruleForm.suguanyuanxingming" 
                placeholder="宿管员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ruzhishijian" label="入职时间" prop="ruzhishijian">
              <el-input v-model="ruleForm.ruzhishijian" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="负责楼号" prop="fuzelouhao">
          <el-select v-model="ruleForm.fuzelouhao" placeholder="请选择负责楼号">
            <el-option
                v-for="(item,index) in fuzelouhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="负责楼号" prop="fuzelouhao">
	      <el-input v-model="ruleForm.fuzelouhao"
                placeholder="负责楼号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='suguanyuanxingming'){
            this.ruleForm.suguanyuanxingming = obj[o];
	    this.ro.suguanyuanxingming = true;
            continue;
          }
	            	            if(o=='xingbie'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='fuzelouhao'){
            this.ruleForm.fuzelouhao = obj[o];
	    this.ro.fuzelouhao = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `suguanyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.suguanyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
